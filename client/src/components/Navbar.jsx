...
function Navbar() {
  ...
  return (
    <>
      <div className="navbar prevent-select transition-all duration-200 fixed overflow-hidden mb-7 z-20 flex  shadow-lg bg-[#fafafa] dark:bg-[#100f0f] dark:text-zinc-100 text-zinc-800 ">
